...
function updatePreview() {
	...
	const { withPlaceholders: withCodeBlockPlaceholders, codeBlocks } =
	...
	previewContent.innerHTML =
		content || "<em>Preview will appear here as you type...</em>";
	preview.replaceChildren(previewContent);

	if (globalThis.Prism && content) {
		globalThis.Prism.highlightAllUnder(previewContent);
	}
}
